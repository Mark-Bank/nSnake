...
INCLUDESDIR = -I"src/" -I"deps/" -I/usr/include/cppconn -I/usr/include/ -I/home/mbank/repos/mysql-connector-cpp
#INCLUDESDIR = -I"src/" -I"deps/" -I/usr/include/cppconn -I/usr/include/ -I/home/mbank/repos/mysql-connector-cpp/driver -I/home/mbank/repos/mysql-connector-cpp/cppconn
...
$(EXE): $(OBJECTS) $(COMMANDER_OBJS)
	# Linking...
	$(CXX) $(OBJECTS) $(COMMANDER_OBJS) -o bin/$(EXE) $(LIBSDIR) $(LDFLAGS)
